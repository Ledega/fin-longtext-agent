...
AFAC2026 挑战组 · 赛题四：金融长文本 Agent 的动态记忆压缩与高效问答挑战

基于 **纯 BM25 倒排索引 + Qwen 系列模型** 的 RAG 问答系统，覆盖保险条款、监管法规、金融合同、财务报表、行业研报五大领域。
...
| ins_a_001 | A | 2739 | 4100 | 6839 |
| ... | ... | ... | ... | ... |

## 技术特点

- **纯 BM25 索引**：不依赖 embedding 模型，符合赛题规则
